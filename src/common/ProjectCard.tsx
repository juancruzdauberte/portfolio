...
export const ProjectCard = ({
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="relative group flex flex-col justify-center w-full rounded-sm overflow-hidden hover:shadow-xl bg-white dark:bg-slate-700"
    >
      <span className="absolute top-1 right-1 text-sm text-center rounded-full border px-1  border-yellow-400 bg-yellow-50 text-yellow-400">
        {t("projectCard.progress")}
      </span>
      <div className="w-full">
        <img className="h-48 w-full object-cover" src={img} />
      </div>
